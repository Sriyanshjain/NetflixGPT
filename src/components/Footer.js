...
const Footer = () => {
  ...
  return (
    <div className='bg-neutral-900 w-screen pt-8 pb-4 px-24'>
        ...
        <div className='flex justify-center mx-auto md:mx-0 gap-2 text-gray-50 pt-4 text-lg md:text-xl  '>
        ...
        <h3 className='text-center   text-gray-50 p-5'>Crafted by <span ><a target='_blank' href='https://www.linkedin.com/in/sriyansh-jain-35b876157/' className='hover:text-red-500'>Sriyansh Jain</a></span></h3>
