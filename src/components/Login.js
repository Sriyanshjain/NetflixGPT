...
return <div>
  ...
  <div className='absolute '>
    ...
    <form onSubmit={(e)=>e.preventDefault()}className='absolute rounded-md mx-auto my-auto top-1/4  left-0 right-0 bg-black bg-opacity-80 px-16 text-white w-10/12 sm:w-5/12 xl:w-3/12 '>
